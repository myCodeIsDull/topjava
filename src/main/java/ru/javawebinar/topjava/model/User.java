...
@NamedQueries({
        ...
        @NamedQuery(name = User.GET_WITH_MEALS, query = "SELECT u FROM User u LEFT JOIN FETCH u.meals WHERE u.id =:userId")
})
@Entity
...
public class User extends AbstractNamedEntity {
    ...
    public static final String GET_WITH_MEALS = "User.namedGetWithMeals";
